...
from Supermemo_project.locators_all.locators import SelectLanguage
...
class RegistrationPage(BasePage):
    ...
    def get_error_password_message_5(self):
        ...
        text = wb.text
        return text
    def get_error_password_message_65(self):
        wb = self.driver.find_element(*SuperMemoLocators.error_paassword_message_65)
        sleep(3)
        text = wb.text
        return text

    def sing_up_button_registration(self):
        subr = self.driver.find_element(*SuperMemoLocators.sign_up_button)
        subr.click()

    def terms_of_use_and_privacy_policy(self):
